...
const Course = () => {
  ...
  useEffect(() => {
    ...
    if (activeTab === "content") {
      navigate.replace("/courses/" + classCode + "/contents");
    } else if (activeTab === "assignments") {
      navigate.replace("/courses/" + classCode + "/assignments");
    }
  }, [activeTab]);
            ...
            <div className="col-11 col-md-10 col-lg-9 col-xl-8 ">
              ...
              <div className="row justify-content-between mt-3">
                ...
                <div className="Reminders">
                  ...
                  <div>
                    {adminName === storeData.userName ? (
                      <div className="d-flex justify-content-center m-2 w-74 float-sm-right">
                        <Button
                          outline
                          color="primary"
                          className="Button_Hover d-flex align-items-center" id="Button"
                    ...
                    {adminName === storeData.userName ? (
                      <div className="d-flex justify-content-center">
                        <Button
                          outline
                          color="primary"
                          className="Button_Hover d-flex align-items-center w-55 float-sm-right" id="Button"
