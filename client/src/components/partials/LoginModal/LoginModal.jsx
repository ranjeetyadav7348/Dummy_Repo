...
import { ASYNC_LOGIN, ASYNC_SIGNUP, handleGoogleClick, selectUserData, SET_ERROR_NULL } from '../../../reduxSlices/authSlice';
...
const LoginModal = (props) => {
  ...
  //const navigate = useNavigate();
   ...
   const handlegoogle=(e)=>{
    ...
    console.log("hua click")
    dispatch(handleGoogleClick());
    navigate('/');
                ...
                <div className="col-12 col-lg-6 px-md-5 mt-4">
                  <form className={classes.root}>
                    ...
                    <div className="d-flex flex-column align-items-center">
                      ...
                      <button onClick={handlegoogle } className="form-btn mx-auto">
              ...
              <div className="row pb-4 mb-1">
                <div className="col-12 col-lg-6 px-md-5">
                  <form className={classes.root}>
                    ...
                    <span> <button onClick={formSubmitHandler} className="form-btn mx-3">
                        Sign Up
                      </button>
                      <button onClick={handlegoogle } className="form-btn mx-4 ">
                        Continue with Google
                      </button></span>
                      {/* <button onClick={formSubmitHandler} className="form-btn mx-auto">
                        Sign Up
